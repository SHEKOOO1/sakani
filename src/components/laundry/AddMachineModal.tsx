...
export function AddMachineModal({ isOpen, onClose, machineName, onMachineNameChange, onSave, saving }: AddMachineModalProps) {
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="p-6 border-b border-slate-100 dark:border-white/10 flex items-center justify-between">
              <h3 className="text-lg font-black text-slate-800 dark:text-white">إضافة غسالة جديدة</h3>
            ...
            <div className="p-8 space-y-6">
              <div>
                <label className="text-[10px] font-black text-slate-400 dark:text-slate-300 uppercase tracking-widest pr-2">اسم الغسالة</label>
                <input 
                  type="text" 
                  value={machineName}
              ...
              >
                {saving ? 'جاري الإضافة...' : 'إضافة الغسالة'}
              </button>
            </div>
          </motion.div>
        </div>
